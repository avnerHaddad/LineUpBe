...
const Login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log({ message: "Login successful", token, user: yield (0, userFunctions_1.FetchUser)(username) });
    return res.json({ message: "Login successful", token, user: yield (0, userFunctions_1.FetchUser)(username) });
});
exports.Login = Login;
function authenticateUser(username, password) {
    let users = (0, userFunctions_1.getAllUsers)();
    console.log(users);
