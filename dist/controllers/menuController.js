...
const getShifts = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        try {
            const recurringShifts = yield (0, ReacuringShiftsFunctions_1.getRecurringShiftsByJobType)(option);
...
const getShiftsByDate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (option === 'none') {
            const shifts = yield (0, ShiftFunctions_1.fetchShiftsByDateOnly)(startDate, endDate);
            const formattedShifts = shifts.map(formatShift);
            res.json(formattedShifts);
        }
        else {
            const shifts = yield (0, ShiftFunctions_1.FetchShiftsByDate)(startDate, endDate, option);
            const formattedShifts = shifts.map(formatShift);
            res.json(formattedShifts);
        }
    }
